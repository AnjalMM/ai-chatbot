...
const Sidebar =({isOpen,toggleSidebar})=> {
  ...
  return (
    <div className={`fixed inset-0 bg-gray-400 p-4 transition-transform transform md:relative md:translate-x-0 md:w-1/4 md:block ${isOpen?"translate-x-0":
        ...
        <div className="text-2xl text-black font-semibold mb-6">ChatBot</div>
      <div className="mb-4">
        <button
           onClick={createChat}
      ...
      <div className='absolute bottom-0 mb-6 w-full'>
        <button className='bg-gray-500 text-white text-xl px-3 py-2 rounded-md
         hover:bg-gray-600' onClick={logoutHandler}>
            Log out
        </button>
      </div>
